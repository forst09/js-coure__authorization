...
/**
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */const He="firebase-heartbeat-database",ze=1,Be="firebase-heartbeat-store";let $e=null;function We(){return $e||($e=function(e,t,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(e,t),a=W(o);return r&&o.addEventListener("upgradeneeded",(e=>{r(W(o.result),e.oldVersion,e.newVersion,W(o.transaction),e)})),n&&o.addEventListener("blocked",(e=>n(e.oldVersion,e.newVersion,e))),a.then((e=>{s&&e.addEventListener("close",(()=>s())),i&&e.addEventListener("versionchange",(e=>i(e.oldVersion,e.newVersion,e)))})).catch((()=>{})),a}(He,ze,{upgrade:(e,t)=>{if(0===t)try{e.createObjectStore(Be)}catch(n){console.warn(n)}}}).catch((e=>{throw Ue.create("idb-open",{originalErrorMessage:e.message})}))),$e}async function qe(e,t){try{const n=(await We()).transaction(Be,"readwrite"),r=n.objectStore(Be);await r.put(t,Ke(e)),await n.done}catch(n){if(n instanceof m)te.warn(n.message);else{const e=Ue.create("idb-set",{originalErrorMessage:null==n?void 0:n.message});te.warn(e.message)}}}function Ke(e){return`${e.name}!${e.options.appId}`}
/**
       * @license
       * Copyright 2021 Google LLC
       *
