...
/**
       ...
       * limitations under the License.
       */
class Z{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const ee="@firebase/app",te="0.10.10",ne=new N("@firebase/app"),re="@firebase/app-compat",ie="@firebase/analytics-compat",se="@firebase/analytics",oe="@firebase/app-check-compat",ae="@firebase/app-check",ce="@firebase/auth",le="@firebase/auth-compat",he="@firebase/database",ue="@firebase/database-compat",de="@firebase/functions",pe="@firebase/functions-compat",fe="@firebase/installations",me="@firebase/installations-compat",ge="@firebase/messaging",ve="@firebase/messaging-compat",be="@firebase/performance",we="@firebase/performance-compat",_e="@firebase/remote-config",ye="@firebase/remote-config-compat",Ie="@firebase/storage",Ee="@firebase/storage-compat",ke="@firebase/firestore",Te="@firebase/vertexai-preview",Se="@firebase/firestore-compat",Ce="firebase",Re="[DEFAULT]",Pe={[ee]:"fire-core",[re]:"fire-core-compat",[se]:"fire-analytics",[ie]:"fire-analytics-compat",[ae]:"fire-app-check",[oe]:"fire-app-check-compat",[ce]:"fire-auth",[le]:"fire-auth-compat",[he]:"fire-rtdb",[ue]:"fire-rtdb-compat",[de]:"fire-fn",[pe]:"fire-fn-compat",[fe]:"fire-iid",[me]:"fire-iid-compat",[ge]:"fire-fcm",[ve]:"fire-fcm-compat",[be]:"fire-perf",[we]:"fire-perf-compat",[_e]:"fire-rc",[ye]:"fire-rc-compat",[Ie]:"fire-gcs",[Ee]:"fire-gcs-compat",[ke]:"fire-fst",[Se]:"fire-fst-compat",[Te]:"fire-vertex","fire-js":"fire-js",[Ce]:"fire-js-all"},Ae=new Map,Oe=new Map,xe=new Map;function Le(e,t){try{e.container.addComponent(t)}catch(n){ne.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ne(e){const t=e.name;if(xe.has(t))return ne.debug(`There were multiple attempts to register component ${t}.`),!1;xe.set(t,e);for(const n of Ae.values())Le(n,e);for(const n of Oe.values())Le(n,e);return!0}function De(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function Ue(e){return void 0!==e.settings}
/**
       * @license
       * Copyright 2019 Google LLC
       *
...
/**
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */()}function yn(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function In(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class En{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return dt("not implemented")}_getIdTokenResponse(e){return dt("not implemented")}_linkToIdToken(e,t){return dt("not implemented")}_getReauthenticationResolver(e){return dt("not implemented")}}async function kn(e,t){return Et(e,"POST","/v1/accounts:signUp",t)}
/**
       * @license
       * Copyright 2020 Google LLC
       *
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */async function Tn(e,t){return Tt(e,"POST","/v1/accounts:signInWithPassword",It(e,t))}async function Sn(e,t){return async function(e,t){return Et(e,"POST","/v1/accounts:sendOobCode",It(e,t))}(e,t)}
/**
       * @license
       * Copyright 2020 Google LLC
       *
...
/**
       ...
       * limitations under the License.
       */
async function $n(e){const t=pn(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function Wn(e,t,n){return Ue(e.app)?Promise.reject(lt(e)):async function(e,t){return Bn(pn(e),t)}(k(e),On.credential(t,n)).catch((async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&$n(e),t}))}async function qn(e,t){const n=k(e),r={requestType:"VERIFY_EMAIL",idToken:await e.getIdToken()},{email:i}=await Sn(n.auth,r);i!==e.email&&await e.reload()}const Kn="__sak";
/**
       * @license
       * Copyright 2019 Google LLC
       *
...
/**
       ...
       * limitations under the License.
       */
const Er="pendingRedirect",kr=new Map;class Tr extends wr{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=kr.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=function(e){return Jt(Er,e.config.apiKey,e.name)}(t),r=function(e){return qt(e._redirectPersistence)}(e);if(!(await r._isAvailable()))return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth),n=t?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}kr.set(this.auth._key(),e)}return this.bypassAuthState||kr.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}}function Sr(e,t){kr.set(e._key(),t)}async function Cr(e,t,n=!1){if(Ue(e.app))return Promise.reject(lt(e));const r=pn(e),i=fr(r,t),s=new Tr(r,i,n),o=await s.execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,t)),o}
/**
       * @license
       * Copyright 2020 Google LLC
       *
